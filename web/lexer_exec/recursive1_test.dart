...
part '../grammars/recursive1.dart';

main() {
  test("testRecursiveLexerRuleRefWithWildcardStar1", () {
    var source = new StringSource("/* ick */\n/* /* */\n/* /*nested*/ */\n");
    var lexer = new Recursive1(source);
  ...
  test("testRecursiveLexerRuleRefWithWildcardStar2", () {
